...
const PLANS = [
  {
    ...
    credits: 1000,
    price: "$5",
    desc: "Great for testing out short podcast scripts",
    features: [
      "~71,000 characters of Speech Turbo",
      "~38,000 characters of Speech HD",
      "Collapsible advanced voice parameters",
      "Private Studio Creations History",
      "Standard Audio Downloads"
    ]
  },
  {
    id: "standard",
    ...
    credits: 2000,
    price: "$10",
    desc: "Perfect for regular podcast creators",
    features: [
      "~142,000 characters of Speech Turbo",
      "~76,000 characters of Speech HD",
      "Collapsible advanced voice parameters",
      "Private Studio Creations History",
      "Standard Audio Downloads",
  ...
  },
  {
    ...
    credits: 4000,
    price: "$20",
    desc: "Ideal for professional narration studios",
    popular: true,
    features: [
      "~285,000 characters of Speech Turbo",
      "~153,000 characters of Speech HD",
      "Private Studio Creations History",
      "Priority Rendering Queue",
      "Standard Audio Downloads",
  ...
  },
  {
    ...
    credits: 10000,
    price: "$50",
    desc: "For production houses and editing teams",
    features: [
      "~714,000 characters of Speech Turbo",
      "~384,000 characters of Speech HD",
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <h1 className="text-3xl font-black font-heading text-white tracking-tight mt-4">
            Simple, Transparent Podcast Pricing
          </h1>
          <p className="text-sm text-zinc-300 mt-2 font-medium">
            ...
            Turbo costs <strong className="text-violet-400">14 credits</strong> per 1,000 characters. 
            HD costs <strong className="text-violet-400">26 credits</strong> per 1,000 characters.
          </p>
        </div>
        ...
        {success && (
          <div className="bg-emerald-950/20 border border-emerald-900/40 rounded-2xl p-6 mb-8 text-center max-w-xl mx-auto shadow-lg animate-in fade-in zoom-in duration-200">
            ...
            <p className="text-xs text-emerald-300/80 leading-relaxed mt-1 max-w-sm mx-auto">
              Your credits have been added successfully to your account. Return to the workstation to generate your audio!
            </p>
            <button
